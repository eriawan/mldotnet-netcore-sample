...
namespace MLDOTNETML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\GITHUB_REPO\mldotnet-netcore-sample\src\MyMLConsoleApp\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../MLDOTNETML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-07f, ConvergenceTolerance = 0.001f, NumberOfIterations = 10, Shuffle = false, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
